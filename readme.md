...
---
# 42 Post Common Core Project: Libasm
...
- `ft_strlen` &mdash; Calculate the length of a string.
- `ft_strcpy` &mdash; Copy a string to another given buffer.
- `ft_strcmp` &mdash; Compare two strings.
- `ft_write` &mdash; Write data to a file descriptor.
- `ft_read` &mdash; Read data from a file descriptor.
